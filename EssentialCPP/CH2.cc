//This is Essential CPP ch2 code
//I just type it follow the book's solution 
#include <iostream>
using namespace std;
...
bool print_sequence (int pos )
{
	...
	cout << "the Fibonact Sequence for "
		 << pos << " position: \n\t";
...
void prog4()
{
	...
	ofstream ofil("C:\\Users\\tedch\\CPPlearn\\EssentialCPP\\data.txt" );
